...
// Portrait images from /public/portrait
const portraitImages = [
    '/portrait/IMG-20250816-WA0002.jpg',
    '/portrait/IMG-20250816-WA0028.jpg',
    '/portrait/IMG-20251116-WA0020.jpg',
    '/portrait/IMG-20251116-WA0060.jpg',
    '/portrait/IMG-20251116-WA0091.jpg',
    '/portrait/IMG_20251214_204333.jpg',
    '/portrait/IMG_20251214_210611.jpg',
];

// Landscape images from /public/landscape
const landscapeImages = [
    '/landscape/IMG-20250816-WA0027.jpg',
    '/landscape/IMG-20251116-WA0049.jpg',
    '/landscape/IMG-20251116-WA0053.jpg',
    '/landscape/IMG-20251214-WA0003.jpg',
    '/landscape/IMG_20251213_194954.jpg',
    '/landscape/IMG_20251214_182206.jpg',
    '/landscape/IMG_20251214_183928.jpg',
    '/landscape/IMG_20251214_183952.jpg',
    '/landscape/IMG_20251214_192607.jpg',
    '/landscape/IMG_20251214_201710.jpg',
];
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="pt-20">
                ...
                <div className="bg-gradient-to-r from-purple-600 to-blue-600 py-16 text-center text-white">
                    ...
                    <p className="text-lg text-white/80">Moments captured from our community and ministry</p>
                </div>
                ...
                {/* Clipped Gallery Grid */}
                <section className="container mx-auto px-4 py-12">
                    <h2 className="text-3xl font-bold text-center mb-8 text-neutral-900">Creative Gallery</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 bg-white border rounded-lg p-5">
                ...
                <section className="container mx-auto px-4 pb-12">
                    <div className="bg-white border rounded-lg p-5">
                        <figure className="relative group">
                            ...
                            >
                                <defs>
                                    <clipPath id="clip-featured" clipPathUnits="objectBoundingBox">
                                        <path
                                            d="M0.0998072 1H0.422076H0.749756C0.767072 1 0.774207 0.961783 0.77561 0.942675V0.807325C0.777053 0.743631 0.791844 0.731953 0.799059 0.734076H0.969813C0.996268 0.730255 1.00088 0.693206 0.999875 0.675159V0.0700637C0.999875 0.0254777 0.985045 0.00477707 0.977629 0H0.902473C0.854975 0 0.890448 0.138535 0.850165 0.138535H0.0204424C0.00408849 0.142357 0 0.180467 0 0.199045V0.410828C0 0.449045 0.0136283 0.46603 0.0204424 0.469745H0.0523086C0.0696245 0.471019 0.0735527 0.497877 0.0733523 0.511146V0.915605C0.0723903 0.983121 0.090588 1 0.0998072 1Z"
                                            fill="#D9D9D9"
                                        />
                                ...
                                <image
                                    clipPath="url(#clip-featured)"
                                    preserveAspectRatio="xMidYMid slice"
                                    width="100%"
                                    height="100%"
                                    xlinkHref={landscapeImages[3]}
                                />
                            </svg>
                        </figure>
                    </div>
                ...
                {/* Standard Gallery */}
                <section className="container mx-auto px-4 pb-12">
                    <h2 className="text-3xl font-bold text-center mb-8 text-neutral-900">All Photos</h2>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {[...portraitImages, ...landscapeImages].map((src, index) => (
