            ...
            <ContainerStagger className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <ContainerAnimated>
                    <div className="flex flex-col justify-center space-y-6">
                        ...
                        <div className="pt-4">
                            <a href="/outreach-ministry" className="inline-block bg-neutral-900 text-white hover:bg-neutral-800 h-10 px-8 rounded-md text-sm font-medium transition-colors leading-10">
                                Learn More
                            </a>
                        </div>
                    </div>
